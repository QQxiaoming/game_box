...
uint8_t  Map69_IRQ_Enable;
uint32_t Map69_IRQ_Cnt;
uint8_t  Map69_Regs[ 1 ];
  ...
  switch ( wAddr )
  {
    ...
    case 0xA000:
      switch ( Map69_Regs[ 0 ] )
      {
        ...
        case 0x0e:
          Map69_IRQ_Cnt = ( Map69_IRQ_Cnt & 0xff00) | (uint32_t)byData;
          break;

        case 0x0f:
          Map69_IRQ_Cnt = ( Map69_IRQ_Cnt & 0x00ff) | ( (uint32_t)byData << 8 );
          break;
      }
      break;
  }
