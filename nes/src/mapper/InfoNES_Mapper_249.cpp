...
uint8_t	Map249_Spdata;
uint8_t	Map249_Reg[8];

uint8_t	Map249_IRQ_Enable;
uint8_t	Map249_IRQ_Counter;
uint8_t	Map249_IRQ_Latch;
uint8_t	Map249_IRQ_Request;
...
{
  uint8_t	byM0,byM1,byM2,byM3,byM4,byM5,byM6,byM7;
